...
bg("GitConflictCurrent", black2)
bg("GitConflictCurrentLabel", black2)
bg("GitConflictIncoming", grey)
bg("GitConflictIncomingLabel", grey)
...
for i, color in ipairs(section_title_colors) do
   cmd("highlight CheatsheetTitle" .. i .. " guibg = " .. color .. " guifg=" .. black)
end
